...
class controller {
    ...
    public:
        controller(){
            service = n.advertiseService("enable_detection", &controller::srvCallback, this);

            ros::Subscriber subParams = n.subscribe("d400/color/camera_info", 1, &controller::cameraInfoCallback, this);
            image_transport::ImageTransport it(n);
            image_transport::Subscriber subImage = it.subscribe("d400/color/image_raw", 1, &controller::imageCallback, this);
        ...
        void imageCallback(const sensor_msgs::ImageConstPtr& msg){
            ...
            try{
                ...
                for(int i = 0; i < markerIds.size(); i++){
                    ...
                    detect.name = to_string(markerIds[i]);
        ...
        bool srvCallback(const std_srvs::SetBool::Request &req, const std_srvs::SetBool::Response &res){
            res.success = true;
            if (req.data == true){
                ros::Subscriber subParams = n.subscribe("d400/color/camera_info", 1, &Subscribe_And_Publish::cameraInfoCallback, this);
